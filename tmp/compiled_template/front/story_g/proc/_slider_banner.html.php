<?php /* Template_ 2.2.7 2025/07/30 05:47:24 /www/newmanjoo14_godomall_com/data/skin/front/story_g/proc/_slider_banner.html 000008694 */ 
...
<?php if($TPL_VAR["bannerSize"]['sizeType']!='%'){?>
    ...
    height: <?php echo $TPL_VAR["bannerSize"]['height']?>px;
<?php }else{?>
    width: 100<?php echo $TPL_VAR["bannerSize"]['sizeType']?>;
<?php }?>
}
.slider-banner-<?php echo $TPL_VAR["bannerCode"]?> .slick-slide img {
<?php if($TPL_VAR["bannerSize"]['sizeType']!='%'){?>
    width: <?php echo $TPL_VAR["bannerSize"]['width']?><?php echo $TPL_VAR["bannerSize"]['sizeType']?>;
    height: <?php echo $TPL_VAR["bannerSize"]['height']?>px;
<?php }else{?>
...
<script src="/data/skin/front/story_g/js/slider/slick/slick.js" type="text/javascript" charset="utf-8"></script>
