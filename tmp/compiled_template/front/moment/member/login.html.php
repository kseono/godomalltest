<?php /* Template_ 2.2.7 2025/05/22 10:03:57 /www/newmanjoo14_godomall_com/data/skin/front/moment/member/login.html 000012169 */ ?>
				...
				<div class="member_login_box">
					...
					<div class="login_input_sec">
						<div>
							...
							<input type="password" id="loginPwd" name="loginPwd" value="" placeholder="<?php echo __('비밀번호')?>" required="true" autocomplete="off"/>
						</div>
...
<?php if($TPL_VAR["useGoogleLogin"]){?>
					<a href="#" class="btn_google_login js_btn_google_login" data-google-type="login" data-return-url="<?php echo $TPL_VAR["returnUrl"]?>"> <img src="/data/skin/front/moment/img/etc/pc_google.png" alt="<?php echo __('구글')?> <?php echo __('아이디 로그인')?>"></a>
<?php }?>
				</div>
