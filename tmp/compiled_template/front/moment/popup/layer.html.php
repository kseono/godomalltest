<?php /* Template_ 2.2.7 2025/05/22 10:03:57 /www/newmanjoo14_godomall_com/data/skin/front/moment/popup/layer.html 000002749 */ ?>
<style type="text/css">
    #<?php echo $TPL_VAR["popupCode"]?>_form {background: <?php echo $TPL_VAR["data"]["popupBgColor"]?>;}
    #<?php echo $TPL_VAR["popupCode"]?>_form .box .view {width:<?php echo ($TPL_VAR["popupWidth"])?><?php echo $TPL_VAR["data"]["sizeTypeW"]?>; height:<?php echo ($TPL_VAR["popupHeight"])?><?php echo $TPL_VAR["data"]["sizeTypeH"]?>; overflow: hidden;}
	...
	#<?php echo $TPL_VAR["popupCode"]?>_form .check .form_element .check_s {background-color:<?php echo $TPL_VAR["todayUnSee"]["todayUnSeeBgColor"]?>;}
...
<div id="<?php echo $TPL_VAR["popupCode"]?>_form" class="sys_pop">
	<div class="box">
		<div class="view">
...
<?php if($TPL_VAR["todayUnSee"]["todayUnSeeFl"]=='y'){?>
		...
		<div class="check">
            <span class="form_element">
                <label for="todayUnSee_<?php echo $TPL_VAR["popupCode"]?>" class="check_s"><?php echo __('오늘 하루 보이지 않음')?></label>
                <input type="checkbox" id="todayUnSee_<?php echo $TPL_VAR["popupCode"]?>" class="checkbox" onClick="gd_popup_cookie('<?php echo $TPL_VAR["popupCode"]?>', this);" />
            </span>
		</div>
		<!-- 오늘 하루 보이지 않음 : end -->
<?php }?>
